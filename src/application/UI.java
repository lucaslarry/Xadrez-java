...
public class UI {
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        ...
        System.out.println(Arrays.toString(captured.stream().filter(x -> x.getColor() == Color.BRANCO).toArray()));
        System.out.print(ANSI_RESET);
        System.out.print("Preto: ");
        System.out.print(ANSI_YELLOW);
        System.out.println(Arrays.toString(captured.stream().filter(x -> x.getColor() == Color.PRETO).toArray()));
        System.out.print(ANSI_RESET);
    }
}